...
function Navbar() {
  // Inline style objects for attractiveness
  const navbarStyle = {
    background: 'linear-gradient(90deg, #f3ae72 0%, #764ba2 100%)',
  ...
  return (
    <>
      {/* Embedded CSS for hover effects (since inline styles can't handle :hover) */}
      <style>
        {`
        
        .navbar-brand {
    color: #1b1b1b !important;   /* brand text color */
  }
  ...
  .nav-link {
    color: #5f4444 !important;   /* link color */
    font-weight: 500;
  }
...
>
         ...
         <svg
          ...
          height="18"
          fill="currentColor"
          className="bi bi-box mb-1" // mb-1 adds spacing below icon
          viewBox="0 0 16 16"
        >
...
>
          ...
          <span>Activities</span>
            ...
            <ul className="navbar-nav ms-auto">
              <li className="nav-item">
                <a className="nav-link custom-nav-link" href="#" style={navLinkStyle}>My Trips</a>
              </li>
              <li className="nav-item">
                <a className="nav-link custom-nav-link" href="#" style={navLinkStyle}>Budget</a>
              </li>
              <li className="nav-item">
                <a className="nav-link custom-nav-link" href="#" style={navLinkStyle}>Recommendations</a>
              </li>
              <li className="nav-item">
                <a className="nav-link custom-nav-link" href="#" style={navLinkStyle}>Alerts</a>
              </li>
              <li className="nav-item">
                <a className="nav-link custom-nav-link" href="/register" style={navLinkStyle}>register</a>
              </li>
            </ul>
          </div>
        </div>
